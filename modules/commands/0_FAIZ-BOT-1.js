...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  if (event.body.includes("Bot") == 1 ||
   ...
   (event.body.includes("KRISHNA") == 1 ||
   (event.body.includes("KRISNA") == 1 ||
   (event.body.includes("@Krisna") == 1 ||
   (event.body.includes("Krish") == 1 ||
   (event.body.includes("KRish") == 1 ||
   (event.body.includes("KRiSna") == 1 ||
